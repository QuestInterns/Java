 ...
 * @author Windows 10
 */
public class PE_MHVS extends javax.swing.JFrame {
...
//                    System.exit(0);
    ...
    private void initComponents() {
        ...
        btnSearch2 = new keeptoo.KButton();
        ...
        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qis/icons8_Exit_25px.png"))); // NOI18N
        jLabel18.setText("MedCert");
        ...
        btnSearch1.setText("VIEW RECORD");
        btnSearch1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnSearch1.setkEndColor(new java.awt.Color(24, 47, 89));
        btnSearch1.setkStartColor(new java.awt.Color(45, 210, 228));
        ...
        btnSearch2.setText("ADD RECORD");
        btnSearch2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnSearch2.setkEndColor(new java.awt.Color(24, 47, 89));
        btnSearch2.setkStartColor(new java.awt.Color(45, 210, 228));
    ...
    private void jLabel4MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MousePressed
        PE_Summary main = new PE_Summary();
        main.setVisible(true);
        this.dispose();
        main.toFront();
    ...
    private void kButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton4ActionPerformed
        ...
        int option = fc.showSaveDialog(PE_MHVS.this);
    ...
    private void btnSearch2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearch2ActionPerformed
        ...
        {
            PE_MHVS_Add main = new PE_MHVS_Add();
            main.setVisible(true);
            main.toFront();
            
            PE_MHVS_VitalSigns main2 = new PE_MHVS_VitalSigns();
            main2.setVisible(true);
            main2.setVisible(false);
            
            PE_MHVS_PE main3 = new PE_MHVS_PE();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PE_MHVS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private keeptoo.KButton btnSearch2;
