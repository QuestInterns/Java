 ...
 * @author Windows 10
 */
public class PE_Summary extends javax.swing.JFrame {
...
//                    System.exit(0);
    ...
    private void kButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton4ActionPerformed
        ...
        int option = fc.showSaveDialog(PE_Summary.this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PE_Summary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PE_Summary().setVisible(true);
            }
        });
    }
